...
//            G.startFragment(FragmentsEnum.MoshtarakFragment,false,bundle);
        ...
        try {
            ...
            holder.tvErrPerc.setText(String.format("%s: %s", G.context.getResources().getText(R.string.ErrorPercent), String.format("%.2f", current.ErrPerc)));
            holder.tvTestTime.setText(String.format("%s: %s %s  ", G.context.getResources().getText(R.string.TestDuration),
